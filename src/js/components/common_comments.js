...
class CommonComments extends React.Component{
  ...
  render(){
	...
	comments.map((comment, index) => (
		<Card key={index} title={comment.UserName} extra={<a href="3">发表于 {comment.datetime}</a>}>
        ...
        <Row>
        	<Col span={24}>
			  ...
			  <Form onSubmit={this.handleSubmit.bind(this)}>
					...
					&nbsp;&nbsp;
					<Button type="primary" htmlType="button" onClick={this.addUserCollection.bind(this)}>收藏改该文章</Button> 
			  </Form>
        	</Col>
        </Row>
      </div>
